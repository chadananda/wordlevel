...
// DOC_LEVEL: check the word frequency reading level of a block of text
// calculates all words and then returns the word level at the 98% range
wordlevel.doc_level("The quick brown cow jumped over the large black dog")
  // 32

// TOPWORDS: Get most difficult words, defaults to top 2% 
var topwords = wordlevel.topwords("The quick brown cow jumped over the large black dog", [2])
 // { quick: 37, jumped: 22 }
